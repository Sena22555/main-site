...
const goalCopy: Record<NutritionGoal, { title: string; adjustment: number; protein: number; image: string; note: string }> = {
  loss: { title: 'Снижение веса', adjustment: -0.17, protein: 1.8, image: '/balanced-plate.jpg', note: 'Умеренный дефицит около 17% от поддержки — без экстремальных ограничений.' },
